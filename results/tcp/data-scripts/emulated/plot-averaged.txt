...
plot "cwnd.txt" using 1:($5/SEGSIZE) title "cwnd" with lines,\
"tcp-put.txt" using 1:12 title "TCP delay" with lines axis x2y2,\
...
"ssthreshold.txt" using 3:($16/SEGSIZE) title "ssthreshold" with lines
