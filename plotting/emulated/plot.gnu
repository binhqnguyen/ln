...
##======== Rx rate only ========
reset
set title "Rx rate ".TCP.", Buffer ".BUFF
set key inside bottom right box
set xlabel "Time (s)"
#set xtic 5
set xrange [x1:x2]
...
plot "cubic.dat" using 1:(($13-1)/SEGSIZE) title "snd_seq" pt 1,\
"enb_dev_queue_drop.txt" using 1:(0) title "enb queue droptail" pt 2 axis x1y2,\
"cubic.dat" using 1:(($15-1)/SEGSIZE) title "next_snd seq" pt 1,\
"retrans.dat" using 1:(0):($2) title "retransmissions" with points pt 6 ps variable
