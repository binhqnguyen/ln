...
typedef  struct cpuinfo_x86   _GLOBAL_33_T; extern  __attribute__((__aligned__((1 << (5)))))   _GLOBAL_33_T  global_boot_cpu_data[NUM_STACKS];    
...
typedef  __typeof__ ( struct tss_struct  )   _GLOBAL_36_T; extern  __attribute__((packed))   _GLOBAL_36_T  global_per_cpu__init_tss[NUM_STACKS];    
