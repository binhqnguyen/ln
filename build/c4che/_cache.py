...
DEFINES = ['NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_PACKET_H=1', 'HAVE_DL=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1', 'HAVE_GSL=1']
DEFINES_ST = '-D%s'
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['wireless', 'realtime', 'udp-client-server', 'tcp', 'udp', 'error-model', 'socket', 'ipv6', 'energy', 'naming', 'tutorial', 'routing', 'stats', 'matrix-topology']
...
NS3_EXECUTABLE_PATH = ['/home/binhn/ln/build/src/emu', '/home/binhn/ln/build/src/fd-net-device', '/home/binhn/ln/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/home/binhn/ln/nsc/lib', '/home/binhn/ln/nsc/linux-2.6.26', '/home/binhn/ln/build']
...
VERSION = '3-dev'
WITH_NSC = '/home/binhn/ln/nsc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/binhn/ln/build/ns3/config-store-config.h', '/home/binhn/ln/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_PACKET_H', 'HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_IF_TUN_H', 'HAVE_DL', 'HAVE_SQLITE3', 'HAVE_GSL']
