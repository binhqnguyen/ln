...
NS3_EXECUTABLE_PATH = ['/var/tmp/ln/build/src/emu', '/var/tmp/ln/build/src/fd-net-device', '/var/tmp/ln/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/var/tmp/ln/nsc/lib', '/var/tmp/ln/nsc/linux-2.6.26', '/var/tmp/ln/build']
...
VERSION = '3-dev'
WITH_NSC = '/var/tmp/ln/nsc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/var/tmp/ln/build/ns3/config-store-config.h', '/var/tmp/ln/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
